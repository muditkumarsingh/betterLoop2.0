...
function RegisterPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-stone-50 p-4 sm:p-8 overflow-hidden">
      ...
      {/* --- BACKGROUND BLOBS --- */}
      {/* Light Yellow/Amber Blob in the Top Left Corner */}
      ...
      <div className="relative z-10 w-full max-w-6xl rounded-[2.5rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] overflow-hidden flex flex-col md:flex-row bg-white/40 backdrop-blur-2xl border border-white/60">
        ...
        <div className="w-full md:w-5/12 p-10 md:p-14 flex flex-col justify-center bg-white/30">
          <div className="max-w-md w-full mx-auto">
            ...
            <form onSubmit={handleRegister} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full bg-[#A8866B] hover:bg-[#8c6c55] text-white font-semibold py-4 rounded-2xl shadow-lg shadow-[#A8866B]/30 hover:shadow-[#A8866B]/40 hover:-translate-y-0.5 transition-all duration-200 mt-2"
              >
                Register
              </button>
            </form>
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-600 font-medium">
                ...
                <Link to="/login" className="text-[#A8866B] hover:text-[#8c6c55] font-bold transition-colors">
                  Log in
                </Link>
              </p>
            </div>
        ...
        <div className="hidden md:flex md:w-7/12 p-4">
          <div className="w-full h-full rounded-[2rem] bg-gradient-to-br from-[#A8866B]/10 to-amber-600/5 flex flex-col items-center justify-center relative overflow-hidden shadow-inner border border-white/40">
            ...
            <div className="absolute bottom-[25%] left-[15%] w-44 bg-white/60 backdrop-blur-md border border-white/80 rounded-2xl p-4 shadow-xl transform rotate-3 animate-[bounce_4s_ease-in-out_infinite]">
            ...
            <div className="absolute bottom-[20%] right-[15%] w-56 bg-white/60 backdrop-blur-md border border-white/80 rounded-2xl p-4 shadow-xl transform -rotate-6 animate-[bounce_7s_ease-in-out_infinite_reverse]">
              <div className="flex items-center gap-4">
            ...
            {/* --- CENTRAL TEXT (Updated for Registration) --- */}
            <div className="relative z-10 text-center pointer-events-none mt-4">
              ...
              <p className="text-gray-600 text-base lg:text-lg font-medium max-w-sm mx-auto leading-relaxed">
                Join thousands of users building better habits, conquering addictions, and taking back control.
              </p>
            </div>
