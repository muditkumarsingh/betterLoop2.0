        ...
        content = (
            <div className='flex justify-center items-center gap-2'>
                            ...
                            <div
                                ...
                                style={{
                                    background: 'linear-gradient(135deg, #B8957A 0%, #A8866B 60%, #96735A 100%)',
                            ...
                            >
                                ...
                                <ul className='space-y-2 ml-1 mb-4'>
                                    {day?.tasks.map((item, index) => (
                                        <li key={index} className='flex items-start gap-2 text-white text-base leading-snug'>
                                            <span
                        ...
                        >
                            <div className='flex justify-between items-center'>
                                ...
                                <IoMdArrowDropdown
                                    ...
                                    style={{ transform: isContentOpen ? 'rotate(180deg)' : 'rotate(0deg)' }}
                                />
                            </div>
            
                            <div
                                className='overflow-hidden transition-all duration-300'
                                style={{ maxHeight: isContentOpen ? '400px' : '0px', opacity: isContentOpen ? 1 : 0 }}
                            >
